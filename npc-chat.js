import { identity, resolveNpcSpeaker, keyName, parseStory, ROLE_ICONS, usable } from './npc-core.js?v=0.40.5';
import { croppedPortrait } from './npc-portraits.js?v=0.40.5';
import { renderSceneTracker } from './scene-tracker.js?v=0.40.5';

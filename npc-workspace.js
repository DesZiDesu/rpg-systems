import { createLoreWorkspace } from './lore-workspace.js?v=0.39.0';
import { FIELDS, STATS, RELATIONS, ROLE_ICONS, identity, profileFields, completeDraft, generatedNpcDraft, generatedAttributes, npcAttributeDefaults, ATTRIBUTE_INSTRUCTIONS, importCharacters, readCharacterFile, keyName, resolveNpc, clean, usable } from './npc-core.js?v=0.39.0';
import { portraitForGeneration, PORTRAIT_INSTRUCTIONS, visualDescription } from './npc-generation.js?v=0.39.0';
import { portraitEditor, preparePortrait, croppedPortrait } from './npc-portraits.js?v=0.39.0';
import { element, icon, speakerHeader, narrative, createChatPresentation } from './npc-chat.js?v=0.39.0';
import { collectPortraitBackups } from './npc-media.js?v=0.39.0';
...
export function createNpcWorkspace(api) {
    ...
    const sheet=document.createElement('link');sheet.rel='stylesheet';sheet.href=new URL('./npc-ui.css?v=0.39.0',import.meta.url).href;document.head.append(sheet);
    ...
    function ensureDialog(){
        ...
        dialog.innerHTML=`<header class="trpg-manager-top"><div><small>CHARACTER ARCHIVE / TRETARESIA</small><h2 id="trpg-manager-title">NPC MANAGEMENT</h2></div><button type="button" data-close aria-label="ปิด">×</button></header>
            ...
            <footer class="trpg-manager-footer"><span role="status" aria-live="polite"></span><span>SCOPED ARCHIVE · v0.39.0</span></footer><div class="trpg-actions trpg-editor-actions" data-editor-actions hidden></div>`;
